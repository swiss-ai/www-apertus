...
[Apertus](https://apertvs.ai/), launched in September 2025, is Switzerland's transparent, fully open-source large language model. It was developed within the [Swiss AI Initiative](https://www.swiss-ai.org/) by [ETH Zürich](https://ethz.ch/en.html), [EPFL](https://www.epfl.ch/en/), and the [Swiss National Supercomputing Centre CSCS](https://www.cscs.ch/). From EPFL, [Natural Language Processing Laboratory](https://nlp.epfl.ch/) and [Machine Learning and Optimization Laboratory](https://www.epfl.ch/labs/mlo/) were instrumental in this effort. 
...
![](https://ai.epfl.ch/wp-content/uploads/Ticino_apertus.webp)
...
- Republished from [ai.epfl.ch/apertus-powers-in-house-ai-translation-for-ticino/](https://ai.epfl.ch/apertus-powers-in-house-ai-translation-for-ticino/)
